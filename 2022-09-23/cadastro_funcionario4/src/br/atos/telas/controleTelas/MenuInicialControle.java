...
public class MenuInicialControle implements ActionListener{
	...
	ListarFuncionario deletarFuncionario = new ListarFuncionario();
	...
	public void actionPerformed(ActionEvent e) {
		if(opcaoMenuJTextField.getText().equals("1") || 
			...
			case "1":
				...
				opcaoMenuJTextField.setText("");
				opcaoMenuJTextField.setFocusable(true);
			...
			case "3":
				deletarFuncionario.apresentarLista(repositorioFuncionario.listarFuncionario(), frameMenuInicial);
				opcaoMenuJTextField.setText("");
				break;
