...
public class TelaDeletarGerente {
	...
	public void deletarGerente(JFrame menuInicialFrame, RepositorioGerente repositorioGerente) {
		...
		//Determina a quantidade de linhas da tabela
				...
				TelaDeletarGerenteControle telaDeletarGerenteControle = new TelaDeletarGerenteControle(frameListarGerente, menuInicialFrame, cpfTextField, repositorioGerente);
