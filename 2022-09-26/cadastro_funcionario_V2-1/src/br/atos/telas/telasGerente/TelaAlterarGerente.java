...
public class TelaAlterarGerente {
	...
	// Strings que serão usadas na Label
			...
			TelaAlterarGerenteControle alterarGerenteControle = new TelaAlterarGerenteControle(frameTelaAlterar, frameMenuInicial, nomeTextField, cpfTextField, salarioLiquidoTextField, repositorioGerente, gerenteAtual);
