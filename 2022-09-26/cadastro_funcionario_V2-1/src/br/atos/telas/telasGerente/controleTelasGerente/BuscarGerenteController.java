...
public class BuscarGerenteController implements ActionListener {
	...
	public void actionPerformed(ActionEvent e) {
		Gerente programadorAtual = new Gerente();
		
		programadorAtual = repositorioGerente.BuscarGerente(cpfField.getText());
		
		if (!(programadorAtual == null)) {
			frameListarGerente.setVisible(false);
			telaAlterarGerente.alterarGerente(frameMenuInicial, repositorioGerente, programadorAtual);
		}
