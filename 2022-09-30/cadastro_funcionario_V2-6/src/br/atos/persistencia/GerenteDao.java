...
public class GerenteDao {
	...
	public boolean alterarGerente(Gerente gerente) {
		...
		String sql = "UPDATE gerente SET  nome = ?, salario_liquido = ?, regional = ?, meta_regional = ?,"
		...
		try {
			...
			pstm.setString(8, gerente.getCpf());
			pstm.setString(1, gerente.getNome());
			pstm.setDouble(2, gerente.getSalarioLiquido());
			pstm.setString(3, gerente.getRegional());
			pstm.setDouble(4, gerente.getMetaRegional());
			pstm.setString(5, gerente.getEndereco().getEstado());
			pstm.setString(6, gerente.getEndereco().getCidade());
			pstm.setString(7, gerente.getEndereco().getRua());
