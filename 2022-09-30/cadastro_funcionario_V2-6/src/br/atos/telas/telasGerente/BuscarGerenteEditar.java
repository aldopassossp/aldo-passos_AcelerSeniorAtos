...
public class BuscarGerenteEditar {
	...
	public void buscarGerente(JFrame menuInicialFrame, RepositorioGerente repositorioGerente) {
		...
		//Cria o frame (janela)
		JFrame frameBuscarGerente = new JFrame();
		frameBuscarGerente.setLocation(150,150);
		frameBuscarGerente.setSize(500,600);
		...
		frameBuscarGerente.add(panelListarGerente);
		frameBuscarGerente.setVisible(true);
		                                                                       				  
		BuscarGerenteController buscarGerenteController = new BuscarGerenteController(frameBuscarGerente, menuInicialFrame, cpfTextField, repositorioGerente);
