...
public class ListarGerente {
	...
	public void apresentarLista(List<Gerente> listaDeGerentees, JFrame frameMenuInicial) {
		...
		for(Gerente gerente: listaDeGerentees) {
			...
			tabelaString [posicaoLinha][posicaoColuna] = gerente.getEndereco().getCidade();
			posicaoColuna++;
		...
		String colunasTitulos[] = {"Nome", "Cpf", "Salário Liquido","Regional","Meta da Regional","Estado","Cidade","Rua"};
		
		//Cria o frame (janela)
		JFrame frameListarGerente = new JFrame();
		frameListarGerente.setLocation(150,150);
		...
		tabelaGerente.setBounds(30,40,250,300);
